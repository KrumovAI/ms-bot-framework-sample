...
namespace Microsoft.BotBuilderSamples
{
    ...
    ";
            ...
            services.AddSingleton<ITurnContextResolverService, TurnContextResolverService>();
            ...
            services.AddSingleton<BotStateAccessors>(sp =>
            {
                // Create the custom state accessor.
                return new BotStateAccessors(userState, conversationState)
                {
                    UserTokensAccessor = userState.CreateProperty<TokensModel>(BotStateAccessors.UserTokensName),
                    MatchingTeachersAccessor = conversationState.CreateProperty<IEnumerable<TeacherViewModel>>(BotStateAccessors.MatchingTeachersName),
                };
            });
