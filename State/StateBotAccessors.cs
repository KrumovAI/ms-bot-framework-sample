...
namespace BasicBot.State
{
    public class BotStateAccessors
    {
        ...
        public static string MatchingTeachersName { get; } = "MatchingTeachers";

        public IStatePropertyAccessor<TokensModel> UserTokensAccessor { get; set; }

        public IStatePropertyAccessor<IEnumerable<TeacherViewModel>> MatchingTeachersAccessor { get; set; }
